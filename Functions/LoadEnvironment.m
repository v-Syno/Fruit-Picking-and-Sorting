function LoadEnvironment
    ...
    %% Table
    table = 'table.ply';
    ObjectClass.PlaceObjects2(table, [0.5,-0.95,0], 'Scale', [0.5,0.4,1]);
    
    %% Scarecrow
    scarecrow = 'scarecrow.ply';
    ObjectClass.PlaceObjects2(scarecrow, [0,1.2,0], 'Scale', [0.4,0.4,0.4]);
    ...
    % Estop
    estop = 'estop.ply';
    ObjectClass.PlaceObjects2(estop, [0.1,-1.1,0.5], 'Scale', [0.5,0.5,0.5]);
